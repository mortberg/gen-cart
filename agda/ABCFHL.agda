-- Proof that "ABCFHL" fibrations are equivalent to weak fibrations
-- when the diagonal is a cofibration.
{-# OPTIONS --rewriting #-}
module ABCFHL where
...
-- "ABCFHL" fibrations following https://github.com/dlicata335/cart-cube
...
private
  ...
  -- as it involves equality in a Σ type.
